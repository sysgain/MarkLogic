Feature: Provision a mainTemplate
    ...
    Scenario Outline: Key is/not Present.
        ...
        | parameters.markLogicLicenseKey        | yes   | template  |
        ...
        | variables.virtualMachineSettings.count      | yes   | template  |
        | variables.virtualMachineSettings.dataDiskSizeGB      | yes   | template  |
